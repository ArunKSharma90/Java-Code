...
// This prgrm is copied directly from Col1_TestCollection. The same collection interface methods are implemented on HashSet this time.
// It will work same on any Collection class, bcoz we are only calling the Collection Interface methods here. 
import java.util.Collection;
import java.util.HashSet;
import java.util.LinkedList;
public class Col2_TestCollections2 {
	public static void main(String[] args) {
		Collection col = new HashSet();   // the returned Obj ref can be stored in 4 ref data types - HashSet, Set, Collection and Object 
